...
const TimeoutError = require('#timeout/TimeoutError');
const EventEmitter = require('#event-emitter');
const EventEmitterAddListener = require(
  '#event-emitter/EventEmitterAddListener'
);
const EventEmitterEmit = require('#event-emitter/EventEmitterEmit');
const EventEmitterRemoveListener = require(
  '#event-emitter/EventEmitterRemoveListener'
);
...
const AbortControllerAbort = (abortController, reason) => {
  ...
  EventEmitterEmit(eventEmitter, 'abort');
  return true;
}
...
const AbortSignalOn = (abortSignal, event, listener, options) => {
  ...
  const unsubscribe = () => EventEmitterRemoveListener(
